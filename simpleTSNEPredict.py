...
def get_args():
    ...
    parser.add_argument('--path', default='/Users/faith_johnson/GitRepos/PedTrajPred/data/', type=str,
...
def train(net, loader, args):
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(opt, args.epochs * len(loader), 1e-12)
    overall_loss = []
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        net.load_state_dict(torch.load('weights/simpleRegNet_diffsData_' + str(args.num_people) + 'people_' + str(args.window)+'window.pt'))
